...
The model with 2 clusters had the smallest value of the ICL, with a value of `r mod2@bestResult@criterionValue` compared to `r mod1@bestResult@criterionValue`. A plot of the optimal clustering is shown below. 
